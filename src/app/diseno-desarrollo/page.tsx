...
export default function DisenoDesarrolloPage() {
  const department = getNavigationItemById("dd");
  const processes = getNavigationChildren("dd");
            ...
            return isActive ? (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#07076b] text-xs font-semibold text-white">
                    {process.code}
                  </div>
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gray-400 text-xs font-semibold text-white">
                    {process.code}
                  </div>
                  <div>
