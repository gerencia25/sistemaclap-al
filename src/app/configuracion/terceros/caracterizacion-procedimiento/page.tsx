...
export default function CaracterizacionProcedimientoPage() {
  ...
  async function handleSaveDocument() {
    ...
    try {
      ...
      const filePath = `CONFIGURACION/TERCEROS/${safeCode}-${safeVersion}-${Date.now()}.pdf`;
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          process_code: "TERCEROS",
          process_name: "Terceros",
      ...
      <section className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-3 max-w-4xl text-base leading-7 text-gray-600">
            Repositorio documental oficial del proceso de terceros.
          </p>
        </div>
            ...
            <div className="mb-6 flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-500">
                  ...
                  oficiales del proceso de terceros.
                </p>
              </div>
